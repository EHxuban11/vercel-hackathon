...
const COOLDOWN_MS = 4_000; // min gap between violations; a new roast cuts off the previous one
      ...
      {phase === "idle" && (
        <div className="flex flex-col items-center gap-6 text-center">
          ...
          <p className="text-xs text-zinc-600 max-w-sm">
            The camera feed is processed entirely in your browser using LibreYOLO v1.2.0 + ONNX Runtime Web. No frames are
